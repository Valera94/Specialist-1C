...
>
>Все что тут есть, это для уровня **Junior**. Для умения пользоваться объектами программы и понимания правил работы с программой. Однако я всегда вместо программы хочу сказать "**Framework без доступа к исходному коду**".
>И список который тут есть, он составлен по моему **наитию** на данный момент времени, да и не всех авторов или полезные ресурсы я отыскал или искал вовсе.
>
